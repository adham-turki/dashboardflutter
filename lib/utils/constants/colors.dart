...
const secondary = Color.fromRGBO(241, 147, 51, 1);
...
final colorListDashboard = <Color>[
  Color(0xff7e4fe4),
  // Color.fromRGBO(30, 36, 48, 1),
  // Colors.teal,
  Color(0xfffd8236),
  // Color.fromRGBO(71, 65, 193, 1),
  Color.fromRGBO(48, 66, 125, 1),
  // Color.fromRGBO(241, 147, 51, 1),
  Color.fromARGB(218, 23, 107, 135),
  Color.fromARGB(169, 255, 208, 150),
  const Color(0xFFFBC02D), // Yellow
  const Color(0xFFf219C90), // Yellow  const Color(0xFFFBC02D), // Yellow
  const Color(0xFF1A237E), // Dark Blue
  const Color(0xFF880E4F), // Dark Pink
  const Color(0xFF3E2723), // Dark Brown
  const Color(0xFF004D40), // Dark Green
