                  ...
                  valueMultipleCustomer == false
                      ? CustomDropDown(
                          ...
                          hint: selectedToCustomers.isNotEmpty
                              ? selectedToCustomers
                              : _locale.select,
                          initialValue: selectedToCustomers.isNotEmpty
                              ? selectedToCustomers
                              : null,
                          onChanged: (value) {
                            setState(() {
                      ...
                      children: [
                        CustomDropDown(
                          ...
                          hint: selectedFromStocks.isNotEmpty
                              ? selectedFromStocks
                              : _locale.select,
                          initialValue: selectedFromStocks.isNotEmpty
                              ? selectedFromStocks
                              : null,
                          onChanged: (value) {
                            setState(() {
                  ...
                  valueMultipleBranches == false
                      ? CustomDropDown(
                          ...
                          hint: selectedToBranches.isNotEmpty
                              ? selectedToBranches
                              : _locale.select,
                          initialValue: selectedToBranches.isNotEmpty
                              ? selectedToBranches
                              : null,
                          onChanged: (value) {
                            setState(() {
                      ...
                      children: [
                        CustomDropDown(
                          ...
                          hint: selectedFromSupplier.isNotEmpty
                              ...
                              : _locale.select,
                          initialValue: selectedFromSupplier.isNotEmpty
                              ? selectedFromSupplier
                              : null,
                          onChanged: (value) {
                            setState(() {
