...
class SessionDateScreen extends StatefulWidget {
  const SessionDateScreen({super.key});

  @override
  State<SessionDateScreen> createState() => _SessionDateScreenState();
}

class _SessionDateScreenState extends State<SessionDateScreen> {
  ...
  Consumer<DatesProvider> actionsWidget() {
